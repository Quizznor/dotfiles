...
HEADPHONE_SINK="alsa_output.usb-GeneralPlus_USB_Audio_Device-00.analog-stereo"
...
case $SELECTED in
  ...
  *""*) # Notebook speakers
  ...
  pacmd set-default-sink $HEADPHONE_SINK  # prefer headphone over default speakers
  ;;
